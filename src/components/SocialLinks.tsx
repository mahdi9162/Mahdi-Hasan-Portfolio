  ...
  const socialLinks = [
    {
      ...
      icon: (
        <svg aria-hidden="true" className="h-full w-full" fill="#0077b5" viewBox="0 0 24 24">
      ...
      {socialLinks.map((link) => (
        ...
        >
          <Button
            variant="ghost"
            size="icon"
            className="hover:bg-white/5 p-2 h-10 w-10 sm:h-auto sm:w-auto sm:p-0 group rounded-lg transition-all duration-300"
            data-magnetic
            asChild
          >
            <a
            ...
            >
              <div className="group-hover:brightness-110 group-hover:drop-shadow-sm transition-all duration-300 w-5 h-5 sm:w-6 sm:h-6" style={{ filter: 'none' }}>
                {link.icon}
              </div>
            </a>
          </Button>
