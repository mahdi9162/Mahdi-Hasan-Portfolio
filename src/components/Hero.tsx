...
const Hero = ({ animationReady = true }: HeroProps) => {
  ...
  return (
    <div className="flex flex-col h-full justify-center pt-8 sm:pt-12 md:pt-24 pb-10 sm:pb-12 md:pb-24">
      <div className="max-w-3xl text-center md:text-start md:max-w-[42ch] lg:max-w-3xl">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute inset-0 bg-brand-gold/20 blur-xl rounded-lg -z-10"
          />
          
          <div className="flex flex-col sm:flex-row md:flex-row items-stretch sm:items-center md:items-center gap-4 mt-6 md:mt-6 lg:mt-8">
            {/* Primary CTA - Resume */}
            <motion.a
