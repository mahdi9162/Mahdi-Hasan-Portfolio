...
const ProfileImage = ({ entryRevealReady = true, profileImageUrl }: ProfileImageProps) => {
  ...
  return (
    <div
      className="profile-image w-full h-[360px] sm:h-[420px] md:max-lg:h-auto md:max-lg:aspect-[4/5] lg:h-[520px] xl:h-screen relative overflow-visible lg:overflow-hidden"
      style={{
        zIndex: 100,
        opacity: 1,
        visibility: 'visible',
    ...
    >
      ...
      >
        <Image
          ...
          className="w-full h-full object-contain md:max-lg:object-cover lg:object-cover grayscale group-hover:grayscale-0 transition-all duration-300 ease-out"
